...
function check_if_added_to_cart($item_id) {
   ...
   $con = mysqli_connect("localhost", "root", "", "foodstore")or die($mysqli_error($con));// connecting to the database
    ...
    $query = "SELECT * FROM orders_temp WHERE item_code='$item_id' AND customer_id='$user_id' and status='Added to cart'";
